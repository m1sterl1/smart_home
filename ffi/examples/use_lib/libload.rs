...
// let new_socket: Symbol<New> = library.get(b"new")?;
// let turn_on: Symbol<TurnOn> = library.get(b"turn_on")?;
// let turn_off: Symbol<TurnOff> = library.get(b"turn_off")?;
// let new_socket: Symbol<Power> = library.get(b"power")?;
impl Lib{
